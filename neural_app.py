...
payload = {
    ...
    "incident_type": st.selectbox("Incident Type", ["Collision","Theft"]),
    "collision_type": st.selectbox("Collision Type", ["Front","Rear","Side"]),
    "incident_severity": st.selectbox("Severity", ["Minor Damage","Major Damage","Total Loss"]),
    "authorities_contacted": st.selectbox("Authorities", ["Police","Fire","No Contact"]),
